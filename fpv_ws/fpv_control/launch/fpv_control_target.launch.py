...
def generate_launch_description():
    ...
    # 生成目标
    spawn_sphere_cmd = f'gz service --service /world/default/create --reqtype gz.msgs.EntityFactory --reptype gz.msgs.Boolean --timeout 1000 --req \'sdf_filename: "/home/sh/sh_ws/src/fpv_control/gz/models/sptball.sdf"\''
