...
{
public:
    VisionControl() : Node("vision_control_PsiRate"),
...
private:
    ...
    void compute_yaw_control(double angle_x_deg) {
        ...
        des_yaw_rate = angle_x_rad * yaw_gain_; 
        
        if (des_yaw_rate > max_yaw_rate_) des_yaw_rate = max_yaw_rate_;
        if (des_yaw_rate < -max_yaw_rate_) des_yaw_rate = -max_yaw_rate_;
      
        RCLCPP_DEBUG_THROTTLE(this->get_logger(), *this->get_clock(), 500,
            "Yaw control: current=%.2f°, (des_yaw_rate=%.1f°)",
            current_yaw_ * 57.3, des_yaw_rate);
    }
    ...
    void publish_trajectory_setpoint() {
        ...
        switch (current_state_) {
            ...
            case State::GUIDANCE:
                ...
                msg.yaw = NAN;
                msg.yawspeed = (float)des_yaw_rate;
                break;
        }
