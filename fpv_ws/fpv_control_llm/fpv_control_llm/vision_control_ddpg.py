...
try:
    ...
    print("Warning: fpv_control.msg not found. Ensure the package is sourced.")
    ImageDeviation = None
...
class VisionControlDRL(Node):
    def __init__(self):
        ...
        default_model_path = os.path.join(home_dir, 'EndToEnd_FPV/RL_FPV/RL_FPV_2D/models/uav_actor_v1.pth')

        # --- 参数 ---
        self.declare_parameter('model_path', default_model_path)
        self.declare_parameter('takeoff_rel_alt', 10.0)
