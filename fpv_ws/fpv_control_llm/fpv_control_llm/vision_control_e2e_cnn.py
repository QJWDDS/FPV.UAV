...
class E2EStateMachine(Node):
    def __init__(self):
        ...
        self.declare_parameter('max_yaw_rate', 1.0)    # 最大角速度限制
        self.declare_parameter('target_loss_timeout', 0.5) 

        home_dir = os.path.expanduser('~')
        model_path = os.path.join(home_dir, 'EndToEnd_FPV/E2E_FPV/E2E_FPV_CNN/models/baylands_e2e_model_v1.pth')
        ...
        self.create_subscription(Image, '/world/baylands/model/x500_mono_cam_0/link/camera_link/sensor/camera/image', self.img_callback, qos_best_effort)
